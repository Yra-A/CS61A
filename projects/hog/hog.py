...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    minv = min(player_score, opponent_score)
    while minv:
        if (player_score % minv == 0 and opponent_score % minv == 0):
            break
        minv -= 1
    return True if minv >= 10 else False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    "My code have been merged with the solution for PROBLEM 5"
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if score_gain > running_high:
            print("%d point(s)! The most yet for Player %d" % (max(running_high, score_gain), who))
        return announce_highest(who, score1 if who else score0, max(running_high, score_gain))       
    return say
    # END PROBLEM 7
