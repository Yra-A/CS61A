...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        while (now_place is not beehive and now_place.entrance is not None):
            if (now_place.bees != [] and self.min_range <= distance <= self.max_range):
                return random.choice(now_place.bees)
